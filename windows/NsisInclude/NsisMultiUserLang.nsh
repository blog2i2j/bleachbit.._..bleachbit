...
!ifdef LANG_ITALIAN
	...
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_ITALIAN} "La versione {VERSION} è installata in $\"{FOLDER}$\" per l'utente corrente."
	...
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_ITALIAN} "Disinstalla la versione {OLD_VERSION} e installa la versione {VERSION} per l'utente corrente."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_ITALIAN} "Reinstalla la versione {VERSION} per tutti gli utenti."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_ITALIAN} "Reinstalla la versione {VERSION} per l'utente corrente."
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_ITALIAN} "È necessario eseguire questo programma con i privilegi di amministratore."
	LangString MULTIUSER_UNINSTALL_HEADER ${LANG_ITALIAN} "$(^NameDA) viene installato sia per tutti gli utenti che per l'utente corrente.$\r$\nSeleziona quale installazione rimuovere."
	LangString MULTIUSER_UNINSTALL_PAGE_SUBTITLE ${LANG_ITALIAN} "Scegli per quali utenti rimuovere $(^NameDA)."
	LangString SECTION_CORE_DESCRIPTION ${LANG_ITALIAN} "Questi sono i file di base necessari (obbligatori) per il funzionamento di ${prodname}."
	...
	LangString SECTION_QUICK_LAUNCH_DESCRIPTION ${LANG_ITALIAN} "Crea un collegamento sulla barra di avvio veloce."
	...
	LangString SECTION_TRANSLATIONS_DESCRIPTION ${LANG_ITALIAN} "Installa i file di lingua per utilizzare ${prodname} nella tua lingua locale preferita."
	LangString SECTION_TRANSLATIONS_NAME ${LANG_ITALIAN} "Traduzioni"
	LangString SECTION_UNINSTALL_DESCRIPTION ${LANG_ITALIAN} "Aggiungi un programma di disinstallazione."
